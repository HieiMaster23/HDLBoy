# =============================================================================
# SDRAM Video ROM Timing Constraints
# Target: sdram_video_rom_top on OMDAZZ RZ-EasyFPGA A2.2
# =============================================================================
# First integrated load-then-execute video bring-up constraint set. SDRAM
# board-level I/O timing remains relaxed until the cartridge/video path is
# proven functionally and the exact SDRAM timing margin is characterized.
# =============================================================================
