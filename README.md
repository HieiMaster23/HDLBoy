...
- Estrutura mínima da CPU (`rtl/cpu/`) implementada com pacote de tipos, banco de registradores, ALU expandida, unidade de controle com microciclos e bloco de interrupções com vetores priorizados.
