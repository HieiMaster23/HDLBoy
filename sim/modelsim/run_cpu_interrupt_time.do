# =============================================================================
# ModelSim script for Blargg interrupt_time/interrupt_time.gb
# Usage from sim/modelsim:
#   vsim -c -do run_cpu_interrupt_time.do
# =============================================================================
...
vsim -c -gG_ROM_PATH=../../gb-test-roms-master/interrupt_time/interrupt_time.gb -gG_TIMEOUT_CYCLES=50000000 work.tb_cpu_rom_runner
run -all
quit -f
