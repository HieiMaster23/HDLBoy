# =============================================================================
# ModelSim script for Blargg cpu_instrs/individual/04-op r,imm.gb
# Usage from sim/modelsim:
#   vsim -c -do run_cpu_blargg_04.do
# =============================================================================
...
vsim -c -gG_ROM_PATH=../../gb-test-roms-master/cpu_instrs/individual/04-OPR~1.GB -gG_TIMEOUT_CYCLES=20000000 work.tb_cpu_rom_runner
run -all
quit -f
