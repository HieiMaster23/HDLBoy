# =============================================================================
# ModelSim script for Blargg cpu_instrs/individual/11-op a,(hl).gb
# Usage from sim/modelsim:
#   vsim -c -do run_cpu_blargg_11.do
# =============================================================================
...
vsim -c -gG_ROM_PATH=../../gb-test-roms-master/cpu_instrs/individual/11-OPA~1.GB -gG_TIMEOUT_CYCLES=50000000 work.tb_cpu_rom_runner
run -all
quit -f
